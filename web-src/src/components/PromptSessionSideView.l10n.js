...
export const intlMessages = {
  promptSessionSideView: {
    ...
    complianceText: {
      defaultMessage: 'Content generated by AI. Review before publishing to your storefront.',
      id: 'promptSessionSideView.complianceText',
      description: 'AI compliance notice shown at the bottom of the prompt panel',
    },
  },
};
